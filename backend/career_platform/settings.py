...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@careerplatform.com")
...
JOB_MATCH_THRESHOLD = 0.60
JOB_MATCH_SEMANTIC_WEIGHT = 0.60
JOB_MATCH_KEYWORD_WEIGHT = 0.40
