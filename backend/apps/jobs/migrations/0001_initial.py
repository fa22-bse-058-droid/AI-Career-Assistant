"""
Initial migration for jobs app.
"""
import uuid
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Indexes for JobListing
        migrations.AddIndex(
            model_name="joblisting",
            index=models.Index(fields=["url"], name="jobs_joblis_url_idx"),
        ),
        migrations.AddIndex(
            model_name="joblisting",
        ...
        migrations.AddIndex(
            model_name="joblisting",
            index=models.Index(fields=["is_remote"], name="jobs_joblis_is_remo_idx"),
        ),
        # Unique constraints
